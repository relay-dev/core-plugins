...
namespace Core.Plugins.Communication.Ftp
{
    /// <summary>
    ...
    public class FtpClientSettings : ConnectionStringParser
    {
        ...
        public FtpClientSettings(string connectionString)
        {
            ...
            IsSftp = Convert.ToBoolean(segments.TryGetValueOrNull("IsSftp"));
        }
        ...
        {
            string timeoutStr = connectionStringProperties.TryGetValueOrNull("TimeoutInSeconds");
